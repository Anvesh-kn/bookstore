...
import static org.shopping.orderservice.testdata.TestDataFactory.*;
...
class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn("Anvesh");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        ...
        given(orderService.createOrder(eq("Anvesh"), any(CreateOrderRequest.class)))
                .willReturn(null);
